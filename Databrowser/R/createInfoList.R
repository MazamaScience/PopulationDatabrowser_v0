...
createInfoList <- function(jsonArgs='{}') {
  ...
  infoList$plotWidth <- ifelse(is.null(infoList$plotWidth),550,as.numeric(infoList$plotWidth))
  infoList$plotHeight <- ifelse(is.null(infoList$plotHeight),550,as.numeric(infoList$plotHeight))
